...
<asp:RadioButtonList ID="RadioButtonList1" runat="server" CssClass="auto-style2" Height="16px" Width="79px" style="margin-left: 106px">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TxtEmail" runat="server" TextMode="Email" CssClass="auto-style1" Width="118px"></asp:TextBox>
    ...
    &nbsp;&nbsp;&nbsp;<asp:TextBox ID="TxtDoj" runat="server" TextMode="Date" Width="118px" CssClass="auto-style2"></asp:TextBox>
    <br />
